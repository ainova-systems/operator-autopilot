...
- `packages/core` — shared types, interfaces, Zod schemas, and error classes. `@operator/core` runtime carries no I/O and no cross-workspace imports; `zod` is its single runtime dependency.
