...
## Problem
`engine/pipeline/composers/pr-feedback-supervisor-stage.ts` is ~280 code
lines (excluding logging/comments/JSDoc) — over the `engine/pipeline/**`
≤200 cap in `intelligence/rules/typescript.md` §FORBIDDEN. The largest
